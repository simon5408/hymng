...
(function($) {
    ...
    $.fn.contextmenu = function(option) {
    	//$.extend 用来在jQuery命名空间上增加新函数/新内容。
	    ...
	    //创建右键每一个菜单列
        itemTpl = "<div class='b-m-$[type]' id='[idtype]' unselectable=on><nobr unselectable=on><img src='$[icon]' align='absmiddle'/><span unselectable=on>$[text]</span></nobr></div>";
        ...
        function showMenu(e, menutarget) {
            ...
            if($.browser.msie){
            	/**
            	 * 注释作者：Simon
            	 * 注释时间：2011年3月14日(传说中的白色情人节)
            	 * 注释原因：针对于IE浏览器，防止右键菜单变形
            	 */
//            	menuH += 100;
            }
            showMenuGroup.call(groups.cmroot, { left: e.pageX, top: menuH }, 0);
