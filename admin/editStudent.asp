...
<%
	...
	exec="select * from normal_stu_info where (stu_id="&Idx&")"
...
%>
	...
	<input type="hidden" name="stuId" value="<%=Idx%>" />
	...
	<table class="trgTbl" width="100%" border="0" cellpadding="1" cellspacing="1" style="background:#f5f5f5">
		...
		<tr>
			...
			<td width="" align="left" colspan="3">
				<input type="text" name="totalTypeFee" id="totalTypeFee" value="<%=rs("total_type_fee")%>"> 元
			</td>
		</tr>
		<% 	typeFee1Years = ""
		...
		<tr>
			...
			<td width="" align="left" colspan="3">
				<input type="text" name="totalFee" id="totalFee"  value="<%=rs("total_fee")%>"> 元
			</td>
		</tr>
		<% 	fee1Years = ""
		...
		<tr>
			...
			<td width="" align="left">
				...
				%>
				<input type="text" name="fee7Memo" id="fee6Memo" <% if userId <> 1 then %> readonly style="background:#e0e0e0;" <% end if %> value="<%=fee7Memo%>"> </td>
	...
	<div id="operateBtn">
		...
		<a href="listStudent.asp" class="easyui-linkbutton" icon="icon-back">返 回</a>
	</div>
	</form>
	<!-- 主体功能区(结束) -->
	</div>
