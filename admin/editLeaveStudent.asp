...
<%
	Idx = Request.QueryString("levStuId")
	exec="select * from leaved_stu_info where (lev_stu_id="&Idx&")"
...
%>
	...
	<div id="right">
	<!-- 主体功能区(开始) -->
	<form  name="editStudent" method="post" action="editLeaveStudentAct.asp">
	<input type="hidden" name="levStuId" value="<%=Idx%>" />
