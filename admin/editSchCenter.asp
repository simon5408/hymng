...
<%
	Idx = Request.QueryString("centerId")
	exec="select * from center_info where (center_id="&Idx&")"
...
<head>
	...
	<script language="javascript" type="text/javascript">
		function doSbmit(){
			var schCenter = $("#schCenter").val();
			if($.trim(schCenter) == ""){
				alert("学习中心为必填项！");
				$("#schCenter").focus();
				$("#schCenter").addClass('errInpt');
				return false;
			}else{
				$("#schCenter").removeClass('errInpt');
			}
...
%>
	...
	<div id="right">
	<!-- 主体功能区(开始) -->
	<form  name="editSchCenter" method="post" action="editSchCenterAct.asp">
	<input type="hidden" name="centerId" value="<%=Idx%>" />
	<div id="oprtDiv">
	<table class="trgTbl" width="100%" border="0" cellpadding="1" cellspacing="1" style="background:#f5f5f5">
		<tr>
			<th width="100" height="50" align="right">学习中心：</th>
			<td width="" align="left"><input type="text" name="schCenter" id="schCenter" style="width:355px"value="<%=rs("sch_center")%>"></td>
		</tr>
		<tr>
	...
	<div id="operateBtn">
		...
		<a href="listSchCenter.asp" class="easyui-linkbutton" icon="icon-back">返 回</a>
	</div>
	</form>
	<!-- 主体功能区(结束) -->
	</div>
