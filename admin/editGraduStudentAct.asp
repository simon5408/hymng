...
<%
gduStuId = request.form("gduStuId")
...
gduDate = CDate(request.form("gduDate"))
gduMemo = request.form("gduMemo")
...
'在读
	'1 删除在读学生信息
	execDel = "delete * from gradut_stu_info where gdu_stu_id = "&gduStuId&""
...
conn.close
set conn=nothing
response.write("<script language=javascript>alert('毕业学生信息编辑成功!');window.close();</script>")
%>