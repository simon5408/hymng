...
ticheng = request.querystring("ticheng")
session("ticheng") = ticheng
...
sql="select * from gradut_stu_info where 1=1 "
...
'介绍人
if ticheng <> "" then
	sql =sql + " and ticheng like '%"&ticheng&"%' "
end if
'手机
if smobile <> "" then
...
sql =sql + " order by gdu_stu_id desc "
