...
<%
levStuId = request.form("levStuId")
...
'在读
	'1 删除退学学生信息
	execDel = "delete * from leaved_stu_info where lev_stu_id = "&levStuId&""
...
conn.close
set conn=nothing
response.write("<script language=javascript>alert('退学学生信息编辑成功!');window.close();</script>")
%>