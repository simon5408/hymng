...
%>
	...
	<div id="right">
	<!-- 主体功能区(开始) -->
	<form  name="addSchCenter" method="post" action="addSchCenterAct.asp">
	<div id="oprtDiv">
	<table class="trgTbl" width="100%" border="0" cellpadding="1" cellspacing="1" style="background:#f5f5f5">
		<tr>
			<th width="100" height="50" align="right">学习中心：</th>
			<td width="" align="left"><input type="text" name="schCenter" id="schCenter" style="width:355px"></td>
		</tr>
		<tr>
