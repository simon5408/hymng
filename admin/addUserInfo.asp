...
%>
	...
	<div id="right">
	<!-- 主体功能区(开始) -->
	<form  name="addUserInfo" method="post" action="addUserInfoAct.asp">
	<div id="oprtDiv">
	<table class="trgTbl" width="100%" border="0" cellpadding="1" cellspacing="1" style="background:#f5f5f5">
		<tr>
			<th width="100" height="50" align="right">登录名称：</th>
			<td width="" align="left"><input type="text" name="username" id="username" style="width:355px"></td>
		</tr>
		<tr>
			<th width="100" height="50" align="right">显示名称：</th>
			<td width="" align="left"><input type="text" name="showname" id="showname" style="width:355px"></td>
		</tr>
		<tr>
			<th width="100" height="50" align="right">登录密码：</th>
			<td width="" align="left"><input type="password" name="password" id="password" style="width:355px"></td>
		</tr>
	</table>
	</div>
	<div id="operateBtn">
