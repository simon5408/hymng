...
%>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="1" style="background:#f5f5f5">
		...
		<tr>
			...
			<td><%=rs("username")%></td>
			<td style="width:80px;">
				<a href='editComName.asp?comId=<%=rs("com_id")%>' class="easyui-linkbutton" plain="true">编辑</a>
				<a href='javascript:doDel(<%=rs("com_id")%>)'class="easyui-linkbutton" plain="true">删除</a>
			</td>
		</tr>
		<% 
			rs.movenext
